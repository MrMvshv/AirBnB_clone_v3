#!/usr/bin/python3
"""
Flask route to return json status response
"""
...
def cities_per_state(state_id=None):
    """
    Cities route handle http method for cities by state req
    """
...
def cities_with_id(city_id=None):
    """
    Cities route for handling http methods for given city
    """
